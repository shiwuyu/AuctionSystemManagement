            ...
            <div class="ali-product-list">
                <div class="ali-product-l">
                    ...
                    <div class="product-list-wrap" id="footer_list">
                        <a target="_blank" class="product-list-link" href="https://blog.csdn.net/qq_45522641">我的博客</a>
                        <a target="_blank" class="product-list-link" href="https://github.com/shiwuyu">我的网站</a>
                    </div>
                </div>
                <div class="ali-product-r">
                    <div class="ali-product-qr-code">
                        <img src="/admin/images/myWechatHead.jpg" alt="" style="border-radius: 4px;">
                        <p>
                            <span>微信头像</span>
                            <span>非常好看</span>
                        </p>
    ...
    <div class="footer_bottom">
        ...
        <div class="phone_box">
            <div class="phone_info">
                ...
                <p class="phone_size">15205534505</p>
                <p>10:00-18:00 (周一至周六)</p>
            </div>
        </div>
    </div>
</div>
